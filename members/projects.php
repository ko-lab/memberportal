...
while ($row = mysqli_fetch_array($result1)) {
    ...
    echo '<tr><td><a class="btn btn-primary btn-xs" href="projects/project.php?project=' . $row['idprojects'] . '">Bewerk</a></td><td>' . $row['name'] . '</td><td>' . $row['description'] . '</td></tr>';
    
}
echo "</tbody></table>";

echo '<form role="form" action="' . $baseurl . 'projects/projectnew.php" method="get">';
